...
import { CreateTicketForm } from '../sections/@dashboard/tickets';
// mock
import ticketList from '../_mock/tickets';
...
const TABLE_HEAD = [
    ...
    { id: 'expires', label: 'Expires at', alignRight: false },
    ...
    return (
        <Page title="Tickets">
            <Container>
                ...
                <Card>
                    {/* replace on ticket List toolbar */}
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                                        const { id, name, created, expires, teacher, status, company, avatarUrl, isVerified } = row;
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell align="left">
                                                    <Link href={teacher.link} underline="hover">
                                                        Y. Matsiulka
                                                    </Link>
                                                </TableCell>
